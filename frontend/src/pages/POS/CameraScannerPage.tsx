...
import {
  ...
  AlertCircle, Scan, Camera, Cpu, WifiOff, RefreshCw,
  Database, Minimize2, Plus, Minus, Trash2
} from 'lucide-react';
...
export default function CameraScannerPage() {
  ...
  /** Capture a video frame and send to backend /api/detect for AI product recognition. */
